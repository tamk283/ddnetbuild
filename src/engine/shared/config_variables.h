...
MACRO_CONFIG_INT(KxAdminAlarm, kx_admin_alarm, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE | CFGFLAG_INSENSITIVE, "Admin Alarm: sound and on-screen alert when a new admin joins the server")
