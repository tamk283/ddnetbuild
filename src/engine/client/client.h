...
class CClient : public IClient, public CDemoPlayer::IListener
{
        ...
        uint64_t m_aSnapshotParts[MAX_DUMMIES] = {};
        ...
        int m_aAckGameTick[MAX_DUMMIES] = {};
        int m_aCurrentRecvTick[MAX_DUMMIES] = {};
        int m_aRconAuthed[MAX_DUMMIES] = {};
        ...
        char m_aTimeoutCodes[MAX_DUMMIES][32] = {};
        bool m_aDidPostConnect[MAX_DUMMIES] = {};
        ...
        // time
        CSmoothTime m_aGameTime[MAX_DUMMIES];
        CSmoothTime m_aPredictedTime[MAX_DUMMIES];
        ...
        struct // TODO: handle input better
        {
                ...
                int64_t m_Time;
        } m_aInputs[MAX_DUMMIES][200];

        int m_aCurrentInput[MAX_DUMMIES] = {};
        int m_LastDummy = 0;
        bool m_aDummySendConnInfo[MAX_DUMMIES] = {};
        bool m_aDummyConnecting[MAX_DUMMIES] = {};
        bool m_aDummyConnected[MAX_DUMMIES] = {};
        float m_aLastDummyConnectTime[MAX_DUMMIES] = {};
        bool m_aDummyReconnectOnReload[MAX_DUMMIES] = {};
        bool m_aDummyDeactivateOnReconnect[MAX_DUMMIES] = {};

        // graphs
        std::vector<CGraph> m_aInputtimeMarginGraphs;
        std::vector<CGraph> m_aGametimeMarginGraphs;
        CGraph m_FpsGraph;

        // the game snapshots are modifiable by the game
        CSnapshotStorage m_aSnapshotStorage[MAX_DUMMIES];
        CSnapshotStorage::CHolder *m_aapSnapshots[MAX_DUMMIES][NUM_SNAPSHOT_TYPES];

        int m_aReceivedSnapshots[MAX_DUMMIES] = {};
        char m_aaSnapshotIncomingData[MAX_DUMMIES][CSnapshot::MAX_SIZE];
        int m_aSnapshotIncomingDataSize[MAX_DUMMIES] = {};
...
public:
        ...
        void RconAuth(const char *pName, const char *pPassword, int Conn = g_Config.m_ClDummy) override;
        ...
        int *GetInput(int Tick, int Conn) const override;
        void ClearInput(int Conn);
        ...
        void DummyDisconnect(int Dummy, const char *pReason) override;
        void DummyConnect(int Dummy) override;
        bool DummyConnected(int Dummy = 1) const override;
        bool DummyConnecting(int Dummy = 1) const override;
        bool DummyConnectingDelayed(int Dummy = 1) const override;
        bool DummyAllowed() const override;
        bool AnyDummyConnected() const override;
        bool AnyDummyConnecting() const override;
        bool AnyDummyConnectingDelayed() const override;
        int DummyCount() const override;
        int LastDummy() const override { return m_LastDummy; }
