...
char *CSkins7::ms_apSkinNameVariables[MAX_DUMMIES] = {nullptr};
char *CSkins7::ms_apSkinVariables[MAX_DUMMIES][protocol7::NUM_SKINPARTS] = {{nullptr}};
int *CSkins7::ms_apUCCVariables[MAX_DUMMIES][protocol7::NUM_SKINPARTS] = {{nullptr}};
int unsigned *CSkins7::ms_apColorVariables[MAX_DUMMIES][protocol7::NUM_SKINPARTS] = {{nullptr}};
...
void CSkins7::OnInit()
{
        ...
        // Dummies 2-7: reuse dummy 1's config variables as fallback
        // (no dedicated config variables exist for dummies 2-7)
        for(Dummy = 2; Dummy < MAX_DUMMIES; Dummy++)
        {
                ms_apSkinNameVariables[Dummy] = Config()->m_ClDummy7Skin;
                ms_apSkinVariables[Dummy][protocol7::SKINPART_BODY] = Config()->m_ClDummy7SkinBody;
                ms_apSkinVariables[Dummy][protocol7::SKINPART_MARKING] = Config()->m_ClDummy7SkinMarking;
