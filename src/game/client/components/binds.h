...
public:
	...
	bool GetKeySegment(const char *pSegment, char *pBuf, size_t BufSize) const;
	void AddBindSegment(const char *pKeyName, const char *pSegment);
	void RemoveBindSegment(const char *pSegment);
...
private:
	...
	bool m_aEdgeActive[KEY_LAST] = {};
	bool m_aEdgeReleased[KEY_LAST] = {};
	bool m_aEdgeKeys[KEY_LAST] = {};
	double m_aEdgePressTime[KEY_LAST] = {};
	char m_aEdgeButtonsCache[256] = {};
	void UpdateEdgeKeys();
};
#endif
