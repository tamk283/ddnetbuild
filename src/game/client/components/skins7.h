...
public:
	...
	static char *ms_apSkinNameVariables[MAX_DUMMIES];
	static char *ms_apSkinVariables[MAX_DUMMIES][protocol7::NUM_SKINPARTS];
	static int *ms_apUCCVariables[MAX_DUMMIES][protocol7::NUM_SKINPARTS]; // use custom color
	static unsigned *ms_apColorVariables[MAX_DUMMIES][protocol7::NUM_SKINPARTS];
